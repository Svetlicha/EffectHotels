...
V29:
- Каналите вече се настройват отделно за всеки хотел.
- В Настройки има секция "Канали по хотели" с добавяне, преименуване и премахване по хотел.
- При въвеждане на проверка се показват само каналите на избрания хотел.
- Данните се пазят в ново поле hotelChannels. Старите файлове с общ channels списък се мигрират автоматично.
- За тази версия трябва да се обнови и Apps Script кодът, за да не изтрива hotelChannels при запис.
